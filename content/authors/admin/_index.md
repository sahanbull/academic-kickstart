...
## Recent News
- We have 3 papers accepted at [27th Int. Conf. on Artificial Intelligence in Education (AIED'25)](https://aied-conference.org/2026). Our 1) full paper titled [Gaze to Insight: A Scalable AI Approach for Detecting Gaze Behaviours in Face-to-Face Collaborative Learning](https://arxiv.org/pdf/2604.03317) is accepted to the  main track while 2) paper "Mix and Match: Context Pairing for Scalable Topic-Controlled Educational Summarisation" and 3) paper "Catching The Correct Answer Trap: Characterising AI Tutor Blind Spots When Analysing Student Reasoning" are accepted to the short paper tracks. More workshop contributions to follow.
